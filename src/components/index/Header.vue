<template>
  <header ref="header">
    ...
    -->
    <div class="view">
      <div id="image1" class="image1" style="background-image: url('/img/bg_image1.png')"/>
    </div>

    <!--  中间动态的文字故障特效=>text-malfunction-->
    <!--
        <div class="text-malfunction" data-word="Naccl's Blog">
        <div class="text-malfunction" data-word="Welcome To Here!" style="margin-left: 40%; width: 50%;">
          <div class="line"></div>
        </div>
    -->
...
.view {
  ...
  /*transform: translatex(calc(var(--percentage) * 100px));*/  /*移动效果*/
}
