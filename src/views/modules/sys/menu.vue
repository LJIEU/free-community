  ...
  methods: {
    ...
    getDataList () {
      ...
      this.$http({
        ...
        // console.log('获取菜单数据列表', response)
        this.dataList = treeDataTranslate(response, 'menuId')
        // console.log('MenuID列表', this.dataList)
